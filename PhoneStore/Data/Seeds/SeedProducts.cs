...
namespace PhoneStore.Data.Seeds
{
    ...
    {
        public static List<Product> CreateProducts(List<Brand> brands)
        {
            var appleBrandId = brands.First(b => b.Title == "Apple").Id;
            var samsungBrandId = brands.First(b => b.Title == "Samsung").Id;
